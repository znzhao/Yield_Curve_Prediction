...
import numpy as np
import pandas as pd
from utils import Timer, getYahooTicker, pushToGithub, findAllFile
...
def parseFredData(series_id, *args, **kwargs):
    '''
    ...
    fred_html = 'https://api.stlouisfed.org/fred/series/observations?series_id={series_id}&api_key={api_key}'.format(series_id = series_id, api_key = api_key)
